        ...
        <div className="space-y-8">
          {experience.map((item, index) => {
            ...
            return (
              ...
              >
                <span className="absolute -left-[38px] top-6 z-10 flex h-10 w-10 items-center justify-center rounded-full border border-cyan-300/60 bg-slate-900 text-cyan-300 shadow-[0_0_16px_rgba(34,211,238,0.45)]">
                  <Icon />
                </span>

                <div className="gradient-card">
                  <div className="glass-card rounded-2xl p-6">
                    <p className="text-sm font-medium text-cyan-300">{item.duration}</p>
