        ...
        <div className="space-y-8">
          {education.map((item, index) => {
            ...
            return (
              ...
              >
                <span className="absolute left-4 top-6 z-10 flex h-10 w-10 -translate-x-1/2 items-center justify-center rounded-full border border-fuchsia-300/60 bg-slate-900 text-fuchsia-300 shadow-[0_0_16px_rgba(217,70,239,0.45)] md:left-auto md:right-0 md:translate-x-1/2">
                  <Icon />
                </span>
                ...
                <div className="gradient-card ml-12 md:ml-0">
                  <div className="glass-card rounded-2xl p-6">
                    ...
                    <h3 className="mt-2 text-xl font-semibold text-white">{item.level}</h3>
                    <p className="mt-2 text-sm text-fuchsia-200">{item.institution}</p>
